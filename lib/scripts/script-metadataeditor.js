...
function baixar() {
  ...
  let PackDeSticker = document.getElementById("PackDeSticker").value
  ...
  let albumValue = document.getElementById("album").value
  ...
  if (PackDeSticker !== "" && PackDeSticker !== "default") {
    metadata.playData.stickerPack = PackDeSticker;
  }
  ...
  if (albumValue !== "") {
    metadata.playData.album = albumValue
  }
